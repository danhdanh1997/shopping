          ...
          <ul>
            ...
            <li data-transition="slidehorizontal" data-slotamount="5" data-masterspeed="700">
              ...
              <div class="tp-caption customin tp-resizeme rs-parallaxlevel-0" data-x="center" data-y="210" data-hoffset="0" data-voffset="98"
                ...
                data-speed="500" data-start="1200" data-easing="Power3.easeInOut" data-splitin="none" data-splitout="none"
              ...
              <?php  foreach($data['khuyenmai'] as $km):?>
                <div class="jtv-product">
                  <div class="product-img">
                      <a title="<?=$km->name?>" href="<?=$km->url?>.html"></a>
                      <img src="public/source/images/products-images/<?php echo $km->image?>" alt="html template"height="125px">
                      <img class="secondary-img" src="public/source/images/products-images/<?php echo $km->image?>"height="125px" alt="html template"> 
                    </a>
                  </div>
                  <div class="jtv-product-content">
                    <h3>
                    <a title="<?=$km->name?>" href="<?=$km->url?>.html"><?=$km->name?></a>
                    </h3>
                    <div class="price-box">
                      <?php
                        ...
                        <p class="special-price">
                          <span class="price-label">Special Price</span>
                          <span class="price"> <?=number_format($km->promotion_price)?> </span>
                        </p>
                        <p class="old-price">
                          <span class="price-label">Regular Price:</span>
                          <span class="price"> <?=number_format($km->price)?> </span>
                        </p>
                        <?php else: ?>
                        <p class="special-price">
                          <span class="price-label">Special Price</span>
                    ...
                    <div class="jtv-product-action">
                      <div class="jtv-extra-link">
                        <div class="button-cart">
                          <button class="button-add-cart" data-id="<?=$km->id?>">
                            <i class="fa fa-shopping-cart"></i>
                          </button>
                        </div>  
                      </div>
          ...
          <div class="col-md-4 col-sm-6">
            <div class="jtv-single-cat">
              <h2 class="cat-title">Sản phẩm mới</h2>
                <?php foreach($data['sanphammoi'] as $spm): ?>   
                  <div class="jtv-product">
                    <div class="product-img">
                        <a title="<?=$spm->name?>" href="<?=$spm->url?>.html"></a>
                        <img src="public/source/images/products-images/<?=$spm->image?>" alt="html template" height="130px"> 
                        <img class="secondary-img" src="public/source/images/products-images/<?=$spm->image?>" alt="html template" height="130px"> </a>
                    </div>
                    <div class="jtv-product-content">
                      <h3>
                      <a title="<?=$spm->name?>" href="<?=$spm->url?>.html"><?=$spm->name?></a>
                      </h3>
                      <div class="price-box">
                        <?php
                          ...
                          <p class="special-price">
                            <span class="price-label">Special Price</span>
                            <span class="price"> <?=number_format($spm->promotion_price)?> </span>
                          </p>
                          <p class="old-price">
                            <span class="price-label">Regular Price:</span>
                            <span class="price"> <?=number_format($spm->price)?> </span>
                          </p>
                          <?php else: ?>
                          <p class="special-price">
                            <span class="price-label">Special Price</span>
                      ...
                      <div class="jtv-product-action">
                        <div class="jtv-extra-link">
                          <div class="button-cart">
                            <button class="button-add-cart" data-id="<?=$spm->id?>">
                              <i class="fa fa-shopping-cart"></i>
                            </button>
                          </div>

      ...
      <div class="single-img-add sidebar-add-slider">
        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel"> 
          ...
          <div class="carousel-inner" role="listbox">
            <div class="item active"> <img src="public/source/images/about_us_slide1.jpg" alt="slide1"> </div>
            <div class="item"> <img src="public/source/images/about_us_slide2.jpg" alt="slide2"> </div>
            <div class="item"> <img src="public/source/images/about_us_slide3.jpg" alt="slide3"> </div>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="row">
    <div class="col-xs-6 col-sm-3 col-md-3">
      <div class="wow bounceInUp" data-wow-delay="0.2s">
        <div class="team">
          <div class="inner">
            <div class="avatar"><img src="public/source/images/team-img01.jpg" alt="" class="img-responsive img-circle" /></div>
            <h5>Joana Doe</h5>
    ...
    <div class="col-xs-6 col-sm-3 col-md-3">
      <div class="wow bounceInUp" data-wow-delay="0.5s">
        <div class="team">
          <div class="inner">
            <div class="avatar"><img src="public/source/images/team-img02.jpg" alt="" class="img-responsive img-circle" /></div>
            <h5>Josefine</h5>
    ...
    <div class="col-xs-6 col-sm-3 col-md-3">
      <div class="wow bounceInUp" data-wow-delay="0.8s">
        <div class="team">
          <div class="inner">
            <div class="avatar"><img src="public/source/images/team-img03.jpg" alt="" class="img-responsive img-circle" /></div>
            <h5>Paulo Moreira</h5>
    ...
    <div class="col-xs-6 col-sm-3 col-md-3">
      <div class="wow bounceInUp" data-wow-delay="1s">
        <div class="team">
          <div class="inner">
            <div class="avatar"><img src="public/source/images/team-img04.jpg" alt="" class="img-responsive img-circle" /></div>
            <h5>Tom Joana</h5>
        ...
        <div id="testimonials-slider" class="product-flexslider hidden-buttons home-testimonials">
          <div class="slider-items slider-width-col4 ">
            <div class="holder">
              ...
              <div class="thumb"> <img src="public/source/images/testimonials-img3.jpg" alt="testimonials img"> </div>
            ...
            <div class="holder">
              ...
              <div class="thumb"> <img src="public/source/images/testimonials-img1.jpg" alt="testimonials img"> </div>
              <strong class="name">Vince Roy</strong> <strong class="designation">CEO, Newspaper</strong> </div>
            <div class="holder">
              <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad 
                minim veniam, quis nostrud. </p>
              <div class="thumb"> <img src="public/source/images/testimonials-img2.jpg" alt="testimonials img"> </div>
              <strong class="name">John Doe</strong> <strong class="designation">CEO, ABC Softwear</strong> </div>
            <div class="holder">
              <p>sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad 
                minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip 
                ex ea commodo consequat.</p>
              <div class="thumb"> <img src="public/source/images/testimonials-img4.jpg" alt="testimonials img"> </div>
      ...
      <div class="slider-items-products">
        <div id="our-clients-slider" class="product-flexslider hidden-buttons">
          <div class="slider-items slider-width-col6"> 
            ...
            <!-- Item -->
            <div class="item"> <a href="#"><img src="public/source/images/brand1.html" alt="Image"></a> <a href="#"><img src="public/source/images/brand2.png" alt="Image"></a> </div>
            <!-- End Item --> 
            
            <!-- Item -->
            <div class="item"> <a href="#"><img src="public/source/images/brand3.png" alt="Image"></a> <a href="#"><img src="public/source/images/brand4.png" alt="Image"></a> </div>
            <!-- End Item --> 
            
            <!-- Item -->
            <div class="item"> <a href="#"><img src="public/source/images/brand5.png" alt="Image"></a> <a href="#"><img src="public/source/images/brand6.png" alt="Image"></a> </div>
            <!-- End Item --> 
            
            <!-- Item -->
            <div class="item"> <a href="#"><img src="public/source/images/brand7.png" alt="Image"></a> <a href="#"><img src="public/source/images/brand3.png" alt="Image"></a> </div>
            <!-- End Item --> 

                  ...
                  <table class="table table-bordered cart_summary">
                    ...
                    <tbody>
                      ...
                      foreach($cart->items as $product):?>
                        <tr class="parent">
                          <td class="cart_image">   
                             <img src="public/source/images/products-images/<?=$product['item']->image?>" alt="">
                          </td>
                          ...
                          <td class="action">
                            <a><i class="icon-close"data-id="<?=$product['item']->id?>"></i></a>
                          </td>
                        </tr>
                      <?php endforeach?>
                    </tbody>
      ...
      success: function(response){
        if(response.success){
          if(response.totalPrice == 0){
            $('.message-cart').html(`
              <p style="color:#fed700; font-size:25px">Giỏ hàng rỗng</p>
              <a class="continue-btn" href="index.php"><i class="fa fa-arrow-left"> </i>&nbsp; Về trang chủ</a>
            `)
          }
          else{
